...
mv Ghostpack-CompiledBinaries Inveigh Windows-Exploit-Suggester PortBender winpspy Sharpmad StreamDivert PassTheCert PrivescCheck.ps1 BadSuccessor.ps1 Coercer pyGPOAbuse KrbRelay ADExplorerSnapshot.py ASRepCatcher ADRecon ADCollector windapsearch Whisker HackBrowserData SharpChromium Rubeus  mimikatz nc.exe bloodyAD krbrelayx ntlm_theft PetitPotam CVE-2023-2255 SharpUp Seatbelt impacket Invoke-Phant0m SharpSploit SharpCollection PrecompiledBinaries BloodHound.py adPEAS donut BloodHound powersploit windowsprivchecker system/windows/
